                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.blogCategories.index') }}" class="btn btn-sm btn-dark">Back</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ route('admin.blogCategories.update', $blogCategory) }}" method="POST" class="needs-validation"
                        novalidate="">
                        @csrf @method('PUT')
                        <div class="card-body">
                            <div class="row">
