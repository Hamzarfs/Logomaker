...
@media only screen and (max-width: 1920px) {
    ...
    <div style="padding-top: 20px; padding-bottom:0px; background-color:#6868D1; background-image: url('images/RFS LOGO-02 2.png'); background-repeat: no-repeat; background-position: left;">
    <div class="container">
        <div class="why-rfs">
