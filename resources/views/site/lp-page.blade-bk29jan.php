            ...
            <div class="col-md-6 lp-left-column">
                ...
                <div class="lpbanner-heading-container" style="display: flex; align-items: center;">
                    ...
                    <h1 class="lpbanner-heading">
                        ...
                        Starting from <span class="lpbanner-price">£35</span>
                    </h1>
                </div>
                <div class="lp-banner-margin">
                    ...
                    <ul class="feature-list">
                        ...
                        <li>Unlimited Revisions on Logo Design</li>
                        <li>Tailored, Client-Centered Approach</li>
                        <li>100% Unique & Custom Designs</li>
                    </ul>
                   
                    <div class="lpbanner-buttons">
                        <button class="btn btn-dark lpbanner-btn mb-2" data-bs-toggle="modal" data-bs-target="#contact-modal"
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="cta-buttons">
                        ...
                        <a href="tel:+02045112009" class="mb-2"> <button class="btn btn-outline-light live-chat-btn">Call
                                Us</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="price-box h-100">
                        ...
                        <button class="start-project-btn" data-bs-toggle="modal" data-bs-target="#contact-modal"
                            data-title="Basic Logo Package - £35">Start Project</button>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="price-box h-100">
                        ...
                        <button class="start-project-btn" data-bs-toggle="modal" data-bs-target="#contact-modal"
                            data-title="Elite Logo Package - £149">Start Project</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="price-box h-100">
                        ...
                        <button class="start-project-btn" data-bs-toggle="modal" data-bs-target="#contact-modal"
                            data-title="Starter Branding Package - £149">Start Project</button>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="price-box h-100">
                        ...
                        <button class="start-project-btn" data-bs-toggle="modal" data-bs-target="#contact-modal"
                            data-title="Professional Branding Package - £329">Start Project</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="price-box h-100">
                        ...
                        <div class="price-section">
                            ...
                            <span class="original-price">£660</span>
                        </div>
                        <p>Only</p>
                        <div class="separator"></div>
                        <ul class="feature-list">
                ...
                <div class="col-md-4">
                    <div class="price-box h-100">
                        ...
                        <button class="start-project-btn" data-bs-toggle="modal" data-bs-target="#contact-modal"
                            data-title="Ecommerce Website Package - £1199">Start Project</button>
                    </div>
                </div>
            </div>
        </div>
...
{{-- 
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="portfolio-column">
            <img src="{{ asset('images/gallery1.png') }}" alt="Portfolio Image 1" class="portfoliogallerylp-image img-fluid">
            <img src="{{ asset('images/gallery2.png') }}" alt="Portfolio Image 2" class="portfoliogallerylp-image img-fluid">
            <img src="{{ asset('images/gallery3.png') }}" alt="Portfolio Image 3" class="portfoliogallerylp-image img-fluid">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="portfolio-column">
            <img src="{{ asset('images/gallery4.png') }}" alt="Portfolio Image 4" class="portfoliogallerylp-image img-fluid">
            <img src="{{ asset('images/gallery5.png') }}" alt="Portfolio Image 5" class="portfoliogallerylp-image img-fluid">
            <img src="{{ asset('images/gallery6.png') }}" alt="Portfolio Image 6" class="portfoliogallerylp-image img-fluid">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="portfolio-column">
            <img src="{{ asset('images/gallery7.png') }}" alt="Portfolio Image 7" class="portfoliogallerylp-image img-fluid">
            <img src="{{ asset('images/gallery8.png') }}" alt="Portfolio Image 8" class="portfoliogallerylp-image img-fluid">
            <img src="{{ asset('images/gallery9.png') }}" alt="Portfolio Image 9" class="portfoliogallerylp-image img-fluid">
        </div>
    </div>
</div>
    ...
    <section class="container py-5 contact-section">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 mb-3 text-center">
                <div class="contact-option">
                    <div class="icon-circle">
                        <a href="tel:+02045112009"><i class="fas fa-phone fa-2x"></i></a>
                    </div>
            ...
            <div class="col-md-4 mb-3 text-center">
                <div class="contact-option">
                    <div class="icon-circle">
                        <a href="mailto:support@rfslogodesign.co.uk"><i class="fas fa-envelope fa-2x"></i></a>
                    </div>
        ...
        <div class="row">
                ...
                <ul class="contact-info">
                    ...
                    <li>
                        <i class="fas fa-map-marker-alt contact-icon"></i>
                         <a href="https://www.google.com/maps?q=Continental+House,+497+Sunleigh+Road,+Wembley,+England,+HA0+4LY" target="_blank" style="color: inherit; text-decoration: none;"> <span>Continental House, 497 Sunleigh Road, <br>Wembley, England, HA0 4LY</span></a>
            ...
            <div class="col-md-7">
                ...
                <form id="contactForm" method="POST" action="{{ route('customLogoSubmit') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Your full name*"
                                name="name" required oninput="validateName(this)">
                        ...
                        <div class="col">
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="E-mail address"
                                name="email" required oninput="validateEmail(this)">
                            <div class="invalid-feedback">Please enter a valid email address.</div>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3">
                        <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone"  placeholder="Enter your phone number*" title="Phone number format: 3334445555"
                            required name="phone" oninput="validatePhone(this)">
                    ...
                    <div class="mb-3">
                        <textarea class="form-control @error('message') is-invalid @enderror" id="message" rows="5" placeholder="Your message*" required name="message" oninput="validateMessage(this)" maxlength="2005"></textarea>
    ...
    <section class="lp-contact-sec d-flex align-items-center pt-4"
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-4">
                    <a href="{{ url('https://wa.me/+447491860363') }}" class="contact-link d-flex align-items-center mb-2">
                        <img src="{{ asset('images/consuilt.png') }}" alt="Support Team Icon" class="me-3" width="65px" />
                        <div>
                ...
                <div class="col-md-4">
                    <a href="tel:+02045112009" class="contact-link d-flex align-items-center mb-2">
                        <img src="{{ asset('images/live.png') }}" alt="Consult Expert Icon"
                            class="me-3" width="65px" />
                        <div>
                ...
                <div class="col-md-4">
                    <a href="{{ url('https://wa.me/+447491860363') }}" class="contact-link d-flex align-items-center mb-2">
                        <img src="{{ asset('images/consuilt.png') }}" alt="Live Support Icon" class="me-3" width="65px"/>
                        <div>
                            <p>Live Support</p>
                            <h5>Chat Now</h5>
                        </div>
