        ...
        <div class="container mt-5">
            <div class="row align-items-center">
                <div class="col-lg-6 about-us-left order-lg-1">
                    ...
                    <h2 style="font-weight: bold; font-size: 24px; color: #646bd9;" >Welcome to RFS LOGO DESIGN</h2>
                    <p class="text-justify  color: #fff; ">Welcome to RFS Logo Design, your one-stop solution for all your branding needs.
