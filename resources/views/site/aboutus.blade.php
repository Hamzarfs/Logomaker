        ...
        <div class="container mt-5">
            <div class="row align-items-center">
                <div class="col-lg-6 about-us-left order-lg-1">
                    <h1 style="font-weight:700; font-size: 42px; color:#fff;">Hello From<span class="logo-design-color">
                            RFS!</span></h1>
                ...
                <div class="col-lg-6 text-center about-us-image-sec order-lg-2">
                    <img src="images/about-us-logo.png" alt="About RFS Logo Design" title= "About RFS Logo Design"
                        class="img-fluid">
                </div>
            </div>
        </div>
    ...
    <section class="choose-us-section">
        <div class="container">
            <div class="choose-us-content">
                ...
                <p style = " text-align:center;">Welcome to RFS Logo Design, your ultimate destination for all things
                    branding. Whether you are
                    using our free logo maker or opting for <a href="{{ url('/custom-logo') }}">custom logo design services</a>,
                    we craft unique and impactful logos tailored to your vision.</p>
                <p style = " text-align:center;">Our expert graphic designers are dedicated
                    to bringing your ideas to life, while our top-notch website development services ensure your online
                    presence matches your brand's strength.</p>
                <p style = " text-align:center;">At RFS, we guarantee a smooth journey with responsive support at every
                    turn.</p>
            ...
            <div class="row mission-content">
                <div class="col-md-7 text">
                    ...
                    <p style = " text-align:justify;">To hit our mission, RFS focuses on using the latest tech for
                        ...
                        complete creative freedom to our talented designers to craft unique logos that make brands shine!
                    </p>
        ...
        <div class="container">
            <div class="row work-content">
                ...
                <div class="col-md-7 text">
                    ...
                    <ul>
                        <li><b>Fun and Easy Process:</b> Choose from a variety of options and enjoy a smooth design
                            experience.</li>
