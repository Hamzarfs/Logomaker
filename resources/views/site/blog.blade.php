    ...
    <section class="blog-page py-5">
        <div class="container">
            <div class="blog-container">
                <img src="{{ $blog->image_url }}" alt="{{ $blog->title }}" class="img-fluid d-block mx-auto">
                ...
                <div class="row g-2 align-items-center justify-content-between mb-3">
                    <div class="col-md-auto">
                        <div class="d-flex gap-3 align-items-center">
                            ...
                            <div class="badge rounded-pill text-bg-primary px-3 py-2">{{ $blog->category->name }}</div>
                        </div>
                    </div>
                    <div class="col-md-auto">
                        <div class="d-flex gap-3 align-items-center">
                            ...
                            <div>
                                <div class="d-flex flex-wrap gap-2 align-items-center ">
                                    @foreach ($blog->tags as $tag)
                                        <div class="badge rounded-pill text-bg-primary px-3 py-2">{{ $tag->name }}</div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
